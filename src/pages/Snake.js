    ...
    render() {
      ...
      image.src = "https://cdn.tutsplus.com/mobile/uploads/legacy/Corona-SDK_Build-A-Snake-Game/1/6.png"
        return (
            ...
            <Layer>
                <Rect x={0} y={0} width={500} height={500} fillPatternImage={image} />
                <Text text={this.mynameis} x={this.state.me.x} y={this.state.me.y+10} />
                <Rect x={this.state.me.x} y={this.state.me.y} width={10} height={10} fill="blue" />
                {Object.keys(this.state.people).map((item, i) => 
                {
                  return this.state.people[item].name !== this.mynameis ?
                    <React.Fragment>
                        <Text  text={this.state.people[item].name} 
                            x={this.state.people[item].x} y={this.state.people[item].y+10} />
                        <Rect x={this.state.people[item].x} y={this.state.people[item].y}
                ...
                <Rect x={this.state.apple.ax} y={this.state.apple.ay}
            ...
            <div className="col">
                ...
                <ul>
                    {Object.keys(this.state.people).map((item, i) => (
                        <ScoreText name={this.state.people[item].name}
